...
const dragging = (e) => {
    if(!isDragging) return; // if(!isDragging) return; // si isDragging es falso regresa desde aquí
...
const infiniteScroll = () => {
    ...
    // If el carrusel está al final, desplácese hasta el principio
...
const autoPlay = () => {
    if(window.innerWidth < 800 || !isAutoPlay) return; // Return if window Es menor que 800 o isAutoPlay es falsa
